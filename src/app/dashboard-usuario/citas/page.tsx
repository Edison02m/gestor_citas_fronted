...
import CitasFilters, { FilterValues } from '@/components/citas/CitasFilters';
...
export default function CitasPage() {
  ...
  const citasFiltradas = useMemo(() => {
    return citas.filter(cita => {
      ...
      // Filtro por servicio
      if (filters.servicioId && cita.servicioId !== filters.servicioId) {
        return false;
      }

      // Filtro por empleado
      if (filters.empleadoId && cita.empleadoId !== filters.empleadoId) {
        return false;
      }

      // Filtro por sucursal
      if (filters.sucursalId && cita.sucursalId !== filters.sucursalId) {
        return false;
      }
