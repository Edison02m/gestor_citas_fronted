...
export default function AgendaPublicaPage() {
  ...
  const handleSubmit = async () => {
    // Solo permitir submit en el paso 4 (confirmación)
    if (paso !== 4) {
      return;
    }
    ...
    try {
      ...
      setPaso(5); // Paso de confirmación final
    } catch (err: any) {
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          {paso < 5 && (
            <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-100">
              <h2 className="text-base sm:text-lg font-bold text-gray-900">
                {paso === 1 ? 'Tus datos' : paso === 2 ? 'Selecciona servicio' : paso === 3 ? 'Fecha y hora' : 'Confirma tu cita'}
              </h2>
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            <div className="px-4 sm:px-8 py-4 sm:py-6 max-h-[70vh] overflow-y-auto">
              ...
              {/* Paso 4: Resumen y Confirmación - Igual que CrearCitaModal */}
              {paso === 4 && (
                <div className="space-y-4">
                  {/* Título del resumen */}
                  <div className="text-center pb-2">
                    <h3 className="text-sm font-bold text-gray-900">Confirma los detalles de tu cita</h3>
                      ...
                      <div className="bg-gray-50 rounded-xl p-3">
                        <div className="flex items-start gap-2.5">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-gray-600 mt-0.5">
                              {codigoPais}{formData.clienteTelefono}
                            </p>
                          </div>
                        </div>
                      </div>
              ...
              {/* Paso 5: Confirmación exitosa - Minimalista */}
              {paso === 5 && (
                <div className="text-center py-4">
                  ...
                  <h2 className="text-xl font-bold text-gray-900 mb-1">¡Cita Agendada!</h2>
                  <p className="text-xs text-gray-600 mb-5">Tu cita ha sido confirmada exitosamente</p>
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="bg-gray-50/50 border border-gray-100 rounded-xl p-5 mb-4 text-left">
                        <h3 className="font-semibold text-gray-900 mb-4 text-sm flex items-center gap-2">
                          <svg className="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="bg-white rounded-lg p-3 border border-gray-100">
                            <div className="flex items-start gap-2">
                              ...
                              <div className="flex-1 min-w-0">
                                <p className="text-sm font-semibold text-gray-900 mb-0.5">{sucursal.nombre}</p>
                                <p className="text-xs text-gray-600">{sucursal.direccion}</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            ...
                            {sucursal.telefono && (
                              <a
                                ...
                                className="flex items-center justify-center gap-2 px-4 py-2.5 bg-green-500 hover:bg-green-600 text-white rounded-xl transition-colors text-xs font-medium shadow-sm"
                              >
                            ...
                            {sucursal.googleMapsUrl && (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center justify-center gap-2 px-4 py-2.5 bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 rounded-xl transition-colors text-xs font-medium shadow-sm"
                              >
                                <svg className="w-4 h-4 text-[#0490C8]" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex gap-2">
                  ...
                  {paso < 4 ? (
                    ...
                    <button
                      ...
                      className="flex-1 px-3 sm:px-4 py-2.5 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-xs sm:text-sm"
                    >
                      {submitting ? (
                        <>
