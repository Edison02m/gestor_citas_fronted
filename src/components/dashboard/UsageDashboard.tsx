    ...
    <div className="bg-white rounded-2xl border border-gray-200 p-6 lg:p-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
        ...
        <button
          ...
          className="px-5 py-2.5 bg-[#0490C8] text-white text-sm font-medium rounded-xl hover:bg-[#023664] transition-all duration-200 flex items-center gap-2 justify-center"
        >
      ...
      <div className="mt-8 pt-6 border-t border-gray-200 flex items-center justify-between">
        ...
        <button
          onClick={cargarResumenUso}
          className="text-[#0490C8] hover:text-[#023664] text-sm font-medium flex items-center gap-1.5 transition-colors"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
